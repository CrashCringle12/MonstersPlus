...
import me.crashcringle.monstersplus.tasks.CleanBlockTask;
import me.crashcringle.monstersplus.tasks.PlaceAndCleanTask;
import me.crashcringle.monstersplus.tasks.RespawnEntityTask;
import me.crashcringle.monstersplus.tasks.TaskTools;
import me.crashcringle.monstersplus.tasks.TntThrowTask;
import me.crashcringle.monstersplus.tasks.VortexCreepTask;
	...
	public static void createIceRing(LivingEntity target, double seconds, boolean useSlow) {
		...
		for (Block block : blocks) {
			...
			// block.getLocation()))
			{
				...
				new CleanBlockTask(Material.LEGACY_STATIONARY_WATER, Material.AIR, block.getLocation(),
						(int) (seconds * 20) * 2);
				if (useSlow) {
