package me.crashcringle.monstersplus.monsters.monsterevents;
...
public class ZombieSpawnEvent {
	...
	public void createMonster() {
		...
		/** LUMBER ZOMBIE easy **/
			...
			ee.setItemInHand(new ItemStack(Material.GOLDEN_AXE));
		...
		/** BURNING WALKER easy **/
			...
			ee.setItemInHand(new ItemStack(Material.FIRE_CHARGE));
			ee.setBoots(boots);
			ee.setHelmet(new ItemStack(Material.PLAYER_HEAD, 1, (short) 1));
		...
		/** Hyde Legendary **/
			...
			ItemStack helm = new ItemStack(Material.PLAYER_HEAD, 1, (short) 5);
